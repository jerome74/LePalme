...
object DataDomain
{
    ...
    private val row_top_sx_91 = Row (listOf<Location>(
        Location( "91", "sunbed_green_free" , 0)
        ,Location("92", "sunbed_green_free" , 0)
        ,Location("93", "sunbed_green_free" , 0)
        ,Location("94", "sunbed_green_free" , 0))
    )
    private val row_top_sx_81 = Row ( listOf<Location>(
        Location("81", "sunbed_green_free" , 0)
        ,Location("82", "sunbed_green_free" , 0)
        ,Location("83", "sunbed_green_free" , 0)
        ,Location("84", "sunbed_green_free" , 0))
    )
    private val row_top_sx_71A = Row ( listOf<Location>(
        Location("71/A", "sunbed_green_free" , 0)
        ,Location("72/A", "sunbed_green_free" , 0)
        ,Location("73/A", "sunbed_green_free" , 0)
        ,Location("74/A", "sunbed_green_free" , 0))
    )
    private val row_top_sx_71 = Row ( listOf<Location>(
        Location("71", "sunbed_green_free" , 0)
        ,Location("72", "sunbed_green_free" , 0)
        ,Location("73", "sunbed_green_free" , 0)
        ,Location("74", "sunbed_green_free" , 0))
    )
    private val row_top_sx_61 = Row ( listOf<Location>(
        Location("61", "sunbed_green_free" , 0)
        ,Location("62", "sunbed_green_free" , 0)
        ,Location("63", "sunbed_green_free" , 0)
        ,Location("64", "sunbed_green_free" , 0))
    )
    ...
    private val row_top_dx_95 = Row (listOf<Location>(
        Location( "95", "sunbed_green_free" , 0)
        ,Location("96", "sunbed_green_free" , 0)
        ,Location("97", "sunbed_green_free" , 0)
        ,Location("98", "sunbed_green_free" , 0)
        ,Location("99", "sunbed_green_free" , 0))
    )
    private val row_top_dx_85 = Row ( listOf<Location>(
        Location("85", "sunbed_green_free" , 0)
        ,Location("86", "sunbed_green_free" , 0)
        ,Location("87", "sunbed_green_free" , 0)
        ,Location("88", "sunbed_green_free" , 0)
        ,Location("89", "sunbed_green_free" , 0))
    )
    private val row_top_dx_75A = Row ( listOf<Location>(
        Location("75/A", "sunbed_green_free" , 0)
        ,Location("76/A", "sunbed_green_free" , 0)
        ,Location("77/A", "sunbed_green_free" , 0)
        ,Location("78/A", "sunbed_green_free" , 0)
        ,Location("79/A", "sunbed_green_free" , 0))
    )
    private val row_top_dx_75 = Row ( listOf<Location>(
        Location("75", "sunbed_green_free" , 0)
        ,Location("76", "sunbed_green_free" , 0)
        ,Location("77", "sunbed_green_free" , 0)
        ,Location("78", "sunbed_green_free" , 0)
        ,Location("79", "sunbed_green_free" , 0))
    )
    private val row_top_dx_65 = Row ( listOf<Location>(
        Location("65", "sunbed_green_free" , 0)
        ,Location("66", "sunbed_green_free" , 0)
        ,Location("67", "sunbed_green_free" , 0)
        ,Location("68", "sunbed_green_free" , 0)
        ,Location("69", "sunbed_green_free" , 0))
    )
    ...
    private val row_botton__dx_6 = Row (listOf<Location>(
        Location( "06", "sunbed_free" , 0)
        ,Location("07", "sunbed_free" , 0)
        ,Location("08", "sunbed_free" , 0)
        ,Location("09", "sunbed_free" , 0)
        ,Location("10", "sunbed_free" , 0))
    )
    private val row_botton__dx_16 = Row ( listOf<Location>(
        Location("16", "sunbed_free" , 0)
        ,Location("17", "sunbed_free" , 0)
        ,Location("18", "sunbed_free" , 0)
        ,Location("19", "sunbed_free" , 0)
        ,Location("20", "sunbed_free" , 0))
    )
    private val row_botton__dx_26 = Row ( listOf<Location>(
        Location("26", "sunbed_free" , 0)
        ,Location("27", "sunbed_free" , 0)
        ,Location("28", "sunbed_free" , 0)
        ,Location("29", "sunbed_free" , 0)
        ,Location("30", "sunbed_free" , 0))
    )
    private val row_botton__dx_36 = Row ( listOf<Location>(
        Location("36", "sunbed_free" , 0)
        ,Location("37", "sunbed_free" , 0)
        ,Location("38", "sunbed_free" , 0)
        ,Location("39", "sunbed_free" , 0)
        ,Location("40", "sunbed_free" , 0))
    )
    private val row_botton__dx_46 = Row ( listOf<Location>(
        Location("46", "sunbed_free" , 0)
        ,Location("47", "sunbed_free" , 0)
        ,Location("48", "sunbed_free" , 0)
        ,Location("49", "sunbed_free" , 0)
        ,Location("40", "sunbed_free" , 0))
    )
    private val row_botton__dx_56 = Row ( listOf<Location>(
        Location("56", "sunbed_free" , 0)
        ,Location("57", "sunbed_free" , 0)
        ,Location("58", "sunbed_free" , 0)
        ,Location("59", "sunbed_free" , 0)
        ,Location("60", "sunbed_free" , 0))
    )
    private val row_botton__dx_66 = Row ( listOf<Location>(
        Location("66", "sunbed_free" , 0)
        ,Location("67", "sunbed_free" , 0)
        ,Location("68", "sunbed_free" , 0)
        ,Location("69", "sunbed_free" , 0)
        ,Location("70", "sunbed_free" , 0))
    )
    private val row_botton__dx_76 = Row ( listOf<Location>(
        Location("76", "sunbed_free" , 0)
        ,Location("77", "sunbed_free" , 0)
        ,Location("78", "sunbed_free" , 0)
        ,Location("79", "sunbed_free" , 0)
        ,Location("80", "sunbed_free" , 0))
    )
