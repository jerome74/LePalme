...
class RowsAdapterMeadowDX (val context : Context, val rows : List<Row>) :  RecyclerView.Adapter<RowsAdapterMeadowDX.Holder>() {
    ...
    inner class Holder (itemView: View?) : RecyclerView.ViewHolder(itemView!!)
    {
        ...
        {
            val tv_1_gr_dx = itemView?.findViewById<TextView>(R.id.tv_1_gr_dx)
            val tv_2_gr_dx = itemView?.findViewById<TextView>(R.id.tv_2_gr_dx)
            val tv_3_gr_dx = itemView?.findViewById<TextView>(R.id.tv_3_gr_dx)
            val tv_4_gr_dx = itemView?.findViewById<TextView>(R.id.tv_4_gr_dx)
            val tv_5_gr_dx = itemView?.findViewById<TextView>(R.id.tv_5_gr_dx)



            val img_sb_1_gr_dx = itemView?.findViewById<ImageView>(R.id.img_sb_1_gr_dx)
            val img_sb_2_gr_dx = itemView?.findViewById<ImageView>(R.id.img_sb_2_gr_dx)
            val img_sb_3_gr_dx = itemView?.findViewById<ImageView>(R.id.img_sb_3_gr_dx)
            val img_sb_4_gr_dx = itemView?.findViewById<ImageView>(R.id.img_sb_4_gr_dx)
            val img_sb_5_gr_dx = itemView?.findViewById<ImageView>(R.id.img_sb_5_gr_dx)

            tv_1_gr_dx?.text = row.locations[0].number.toString()
            tv_2_gr_dx?.text = row.locations[1].number.toString()
            tv_3_gr_dx?.text = row.locations[2].number.toString()
            tv_4_gr_dx?.text = row.locations[3].number.toString()
            tv_5_gr_dx?.text = row.locations[4].number.toString()
            ...
            img_sb_1_gr_dx?.setOnClickListener({
                ...
                if(row.locations[0].reserved == 1)
                {
                    ...
                    builder.setView(dialogView)
                        ...
                        .setPositiveButton("Inserisci", { dialog: DialogInterface?, which: Int ->
                            ...
                            img_sb_1_gr_dx.setImageDrawable(rounded_1);
            ...
            img_sb_2_gr_dx?.setOnClickListener({
                ...
                if(row.locations[1].reserved == 1)
                {
                    ...
                    builder.setView(dialogView)
                        ...
                        .setPositiveButton("Inserisci", { dialog: DialogInterface?, which: Int ->
                            ...
                            img_sb_2_gr_dx.setImageDrawable(rounded_2);
            ...
            img_sb_3_gr_dx?.setOnClickListener({
                ...
                if(row.locations[2].reserved == 1)
                {
                    ...
                    builder.setView(dialogView)
                        ...
                        .setPositiveButton("Inserisci", { dialog: DialogInterface?, which: Int ->
                            ...
                            img_sb_3_gr_dx.setImageDrawable(rounded_3);
            ...
            img_sb_4_gr_dx?.setOnClickListener({
                ...
                if(row.locations[3].reserved == 1)
                {
                    ...
                    builder.setView(dialogView)
                        ...
                        .setPositiveButton("Inserisci", { dialog: DialogInterface?, which: Int ->
                            ...
                            img_sb_4_gr_dx.setImageDrawable(rounded_4);
            ...
            img_sb_5_gr_dx?.setOnClickListener({
                ...
                if(row.locations[3].reserved == 1)
                {
                    ...
                    builder.setView(dialogView)
                        ...
                        .setPositiveButton("Inserisci", { dialog: DialogInterface?, which: Int ->
                            ...
                            img_sb_5_gr_dx.setImageDrawable(rounded_5);
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Holder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.sunbed_list_green_dx_item ,parent,false)
